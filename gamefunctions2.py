...
quantitytoPurchase = int(input("Enter quanitity desired: "))

purchase_item(itemPrice, startingMoney, quantitytoPurchase) #prints post purchase item quantity and change

print("\nAn enemy approaches! \n    ----------")
monster = random_monster() #monster is revealed to the user with notable qualities and information
